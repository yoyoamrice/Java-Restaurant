...
import java.util.Optional;
	...
	public class ProductRecipeController {
		...
		public ProductRecipeController(ProductRecipeService productRecipeService, ProductRecipeRepository productRecipeRepository) {
		...
		public ResponseEntity<List<ProductRecipe>> getRecipesByCategoryAndDietaryPreference(
			...
			List<ProductRecipe> recipes = productRecipeService.findByCategoryAndDietaryPreferenceIgnoreCase(
				recipeCategory,
		...
		@PutMapping("/{id}")
		public ResponseEntity<ProductRecipe> updateRecipe(
			@PathVariable Long id,
			@RequestBody ProductRecipe updatedRecipe
		) {
